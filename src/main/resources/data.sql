...
VALUES
    ((SELECT crochet_stitch_id FROM crochet_stitch WHERE stitch_name = 'Single Crochet'),
	...
	((SELECT crochet_stitch_id FROM crochet_stitch WHERE stitch_name = 'Single Crochet'),
 	...
 	5),
 	((SELECT crochet_stitch_id FROM crochet_stitch WHERE stitch_name = 'Chain'),
 	'Yarn over',
 	1),
 	((SELECT crochet_stitch_id FROM crochet_stitch WHERE stitch_name = 'Chain'),
 	...
 	3),
 	((SELECT crochet_stitch_id FROM crochet_stitch WHERE stitch_name = 'Slip Stitch'),
 	...
 	3),
 	((SELECT crochet_stitch_id FROM crochet_stitch WHERE stitch_name = 'Double Crochet'),
 	'Yarn over',
 	1),
 	((SELECT crochet_stitch_id FROM crochet_stitch WHERE stitch_name = 'Double Crochet'),
